    ...
    function(e, t, n) {
      ...
      var i =
        ...
        (t.swipeStart = function(e, t, n) {
          return !t || (!n && e.type.indexOf("mouse") !== -1)
            ? ""
            : {
                dragging: !0,
                touchObject: {
        ...
        (t.swipeMove = function(e, t) {
          ...
          if ((e.preventDefault(), !n && !r)) {
            ...
            if (!s && !f && M > 10) return { scrolling: !0 };
            s && (w.swipeLength = M);
            ...
            return (
              S ||
                (((0 === l && "right" === z) ||
                  ...
                  (!g(t) && "left" === z)) &&
                  ((P = w.swipeLength * c),
                  u === !1 && d && (d(z), (x.edgeDragged = !0)))),
              !p && m && (m(z), (x.swiped = !0)),
              (_ = o ? E + P * (b / T) * L : a ? E - P * L : E + P * L),
              s && (_ = E + P * L),
              (x = i({}, x, {
                touchObject: w,
                swipeLeft: _,
                trackStyle: k(i({}, t, { left: _ }))
              })),
              Math.abs(w.curX - w.startX) < 0.8 * Math.abs(w.curY - w.startY)
                ? x
                : (w.swipeLength > 10 && (x.swiping = !0), x)
            );
          }
        }),
